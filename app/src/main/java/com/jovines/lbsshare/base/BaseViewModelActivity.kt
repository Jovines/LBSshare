...
abstract class BaseViewModelActivity<T : BaseViewModel> : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.apply {
            toastEvent.observe { str -> str?.let { Toast.makeText(baseContext, it, Toast.LENGTH_SHORT).show() } }
            longToastEvent.observe { str -> str?.let { Toast.makeText(baseContext, it, Toast.LENGTH_LONG).show() } }
